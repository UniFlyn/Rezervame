...
/// Loads a network image and, on failure, tries further URLs (real photos only — no icon placeholders).
class ChainedNetworkImage extends StatelessWidget {
  ...
  static const List<String> _fallbackIds = [
    DefaultVenueHero.unsplashPhotoId,
    '1544161515-4ab6ce6db874',
    '1487412947147-5cebf100ffc2',
    '1487412947147-5cebf100ffc2',
    '1588776814546-1ffcf47267a5',
    '1519014816541-da1916305741',
  ...
  /// Ordered Unsplash URLs from [unsplashId], then shared alternates, then Picsum.
  static List<String> urlsForUnsplashId(String? unsplashId, {int w = 500}) {
    ...
    final out = <String>[];
    for (final id in ids) {
      if (seen.add(id)) out.add(_unsplash(id, w));
    }
    out.add('https://picsum.photos/seed/rezervame-venue/800/600');
    return out;
  }
