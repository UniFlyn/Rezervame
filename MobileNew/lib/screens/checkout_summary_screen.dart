...
class _CheckoutSummaryScreenState extends State<CheckoutSummaryScreen> {
  static const List<String> _defaultSpecialists = [
    'Mateo Ríos',
    'Sofia Lara',
    'Daniel Vera',
    'Elena Soler',
  ...
  /// Unsplash photo ids (aligned with [ServiceDetailScreen] team mock).
  static const Map<String, String> _specialistUnsplashIds = {
    'Mateo Ríos': '1503951914875-452162b0f3f1',
    'Sofia Lara': '1494790108377-be9c29b29330',
    'Daniel Vera': '1500648767791-00dcc994a43e',
    'Elena Soler': '1522337660859-02fbefca4702',
  };

  static String _photoIdForSpecialist(String name) =>
      _specialistUnsplashIds[name.trim()] ?? DefaultVenueHero.unsplashPhotoId;
  ...
  void initState() {
    ...
    final names = widget.specialistNames ?? _defaultSpecialists;
    _specialist = names.isNotEmpty ? names.first : '—';
                        ...
                        children: [
                          ...
                          ClipRRect(
                            ...
                            child: ChainedNetworkImage(
                              urls: ChainedNetworkImage.urlsForUnsplashId(_photoIdForSpecialist(n), w: 200),
                              width: 44,
                              height: 44,
                              fit: BoxFit.cover,
                            ),
        ...
        child: Container(
          ...
          child: Row(
            children: [
              ...
              Expanded(child: Text('•••• •••• •••• 4859', style: AppTypography.body200.copyWith(color: AppColors.grey900))),
  ...
  String _unsplashIdFromHeroUrl(String url) {
    ...
    return DefaultVenueHero.unsplashPhotoId;
  }
