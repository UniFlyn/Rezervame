...
class _BusinessRegistrationFlowState extends State<BusinessRegistrationFlow> {
              ...
              Expanded(
                child: Padding(
                  ...
                  child: OutlinedButton(
                    ...
                    child: Text('back'.tr(), style: AppTypography.buttonMedium.copyWith(color: AppColors.grey900)),
                  ),
                ),
              ),
            Expanded(
  ...
  Widget _buildIdentificationStep() {
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          Text('bizRegTellUs'.tr(), style: AppTypography.screenTitle.copyWith(color: AppColors.grey900)),
          const SizedBox(height: 8),
          Text('bizRegTellUsSub'.tr(), style: AppTypography.screenSubtitle.copyWith(color: AppColors.grey500, height: 1.5)),
  ...
  Widget _buildContactStep() {
     return SingleChildScrollView(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text('bizRegReachYou'.tr(), style: AppTypography.screenTitle.copyWith(color: AppColors.grey900)),
          const SizedBox(height: 32),
  ...
  Widget _buildLocationStep() {
     return SingleChildScrollView(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text('bizRegLocation'.tr(), style: AppTypography.screenTitle.copyWith(color: AppColors.grey900)),
          const SizedBox(height: 32),
  ...
  Widget _buildServicesStep() {
     return SingleChildScrollView(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text('bizRegServices'.tr(), style: AppTypography.screenTitle.copyWith(color: AppColors.grey900)),
          const SizedBox(height: 32),
          ...
          TextButton.icon(
            ...
            label: Text('bizRegAddCustom'.tr(), style: AppTypography.buttonSmall),
          ),
        ],
      ),
    );
  ...
  Widget _buildServiceCheck(String title, bool val) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: val ? AppColors.primary500.withValues(alpha: 0.05) : AppColors.white,
        borderRadius: BorderRadius.circular(12),
        border: Border.all(color: val ? AppColors.primary500.withValues(alpha: 0.2) : AppColors.grey50),
      ),
      child: Row(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            const SizedBox(height: 24),
            Text('bizRegWelcome'.tr(), textAlign: TextAlign.center, style: AppTypography.screenTitle.copyWith(color: AppColors.grey900)),
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                ...
                child: Text('backToHome'.tr(), style: AppTypography.buttonLarge.copyWith(color: AppColors.white)),
              ),
            ),
            const SizedBox(height: 8),
          ],
