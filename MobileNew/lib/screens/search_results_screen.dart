...
class _SearchResultsScreenState extends State<SearchResultsScreen> {
  ...
  String _appliedLocation = 'Los Angeles, CA';
  int _appliedSheetCategoryIndex = 0;

  late List<Map<String, dynamic>> _filteredResults;

  late final List<Map<String, dynamic>> _sourceResults = VenueCatalog.allAsSearchMaps();
...
class _FilterSearchSheetState extends State<_FilterSearchSheet> {
  static const List<String> _locations = ['Los Angeles, CA', 'Panama City, PA', 'Miami, FL'];
  ...
  void initState() {
    super.initState();
    _location = _locations.contains(widget.initialLocation) ? widget.initialLocation : _locations.first;
              ...
              Container(
                ...
                child: DropdownButtonHideUnderline(
                  child: DropdownButton<String>(
                    ...
                    value: _location,
                    items: _locations
                        .map((e) => DropdownMenuItem(value: e, child: Text(e, style: AppTypography.body200)))
                        .toList(),
                    onChanged: (v) {
