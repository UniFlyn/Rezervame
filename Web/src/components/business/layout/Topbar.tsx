    ...
    <header className="h-16 bg-white border-b border-gray-200 flex items-center justify-between px-6 sticky top-0 z-10 w-full shadow-sm">
      ...
      <div className="flex items-center space-x-4">
        <button
          type="button"
          title="Notifications"
          className="text-gray-500 hover:text-gray-700 relative p-2 rounded-xl hover:bg-slate-50"
        >
        ...
        <Link
          ...
          className="flex items-center space-x-2 text-gray-700 hover:text-gray-900 p-2 rounded-xl hover:bg-slate-50"
        >
