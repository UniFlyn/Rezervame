...
export default function TermsPage() {
  return (
    ...
    >
      <p className="text-[var(--rz-gray-500)] font-bold text-xs uppercase tracking-widest mb-6">
        Effective starting: March 30, 2026.
      </p>

      <div className="space-y-8 mt-8">
        <div className="space-y-2">
          <h2 className="text-xl font-black uppercase tracking-wide text-[var(--rz-navy)]">1. Acceptance of Terms</h2>
          <p className="text-[var(--rz-gray-600)] font-medium leading-relaxed">
        ...
        <div className="space-y-2">
          <h2 className="text-xl font-black uppercase tracking-wide text-[var(--rz-navy)]">2. Use of the Platform</h2>
          <p className="text-[var(--rz-gray-600)] font-medium leading-relaxed">
        ...
        <div className="space-y-2">
          <h2 className="text-xl font-black uppercase tracking-wide text-[var(--rz-navy)]">3. Cancellation Policy</h2>
          <p className="text-[var(--rz-gray-600)] font-medium leading-relaxed">
        ...
        <div className="space-y-2">
          <h2 className="text-xl font-black uppercase tracking-wide text-[var(--rz-navy)]">4. Limitation of Liability</h2>
          <p className="text-[var(--rz-gray-600)] font-medium leading-relaxed">
