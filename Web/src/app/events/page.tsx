      ...
      <div className="space-y-12 mt-10">
        ...
        {events.map((event) => {
          ...
          return (
            <div
              key={event.id}
              className="flex flex-col md:flex-row gap-8 bg-[var(--rz-gray-050)] rounded-[32px] overflow-hidden border border-[var(--rz-gray-100)] group hover:shadow-2xl transition-all duration-500"
            >
              <div className="w-full md:w-1/3 aspect-video md:aspect-square overflow-hidden bg-[var(--rz-gray-200)]">
                <img
              ...
              <div className="flex-1 p-8 flex flex-col justify-center">
                <div className="flex items-center gap-2 text-[#ff5757] text-[10px] font-black uppercase tracking-widest mb-4">
                  <CalendarIcon size={14} /> {dateLabel}
                </div>
                <h3 className="text-2xl font-black uppercase text-[var(--rz-navy)] mb-2">{event.title}</h3>
                <p className="text-sm text-[var(--rz-gray-600)] mb-4 line-clamp-4">{event.body}</p>
                <div className="flex items-center gap-2 text-sm font-bold text-[var(--rz-gray-500)] mb-6">
                ...
                <div className="flex flex-wrap items-center justify-between gap-4 mt-auto">
                  ...
                  {event.websiteUrl ? (
                    <a
                      ...
                      className="bg-[var(--rz-navy)] text-white px-8 py-3 rounded-xl text-[10px] font-black uppercase tracking-widest flex items-center gap-2 hover:bg-[#ff5757] transition-all"
                    >
